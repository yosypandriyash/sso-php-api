...
class UsersBaseModel extends BaseModel {
	...
	{
		return $this->validateField($this->validationRules['userName'], $userName);
	}

	public function validateFullName($fullName = null)
	{
		return $this->validateField($this->validationRules['fullName'], $fullName);
	}

	public function validateEmail($email = null)
	{
		return $this->validateField($this->validationRules['email'], $email);
	}

	public function validatePassword($password = null)
	{
		return $this->validateField($this->validationRules['password'], $password);
	}
